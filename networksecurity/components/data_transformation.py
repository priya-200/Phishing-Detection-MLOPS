...
class DataTransformation:
    ...
    def get_data_transformer_object(cls) -> Pipeline:
        ...
        try:
            # The double starts (**) indicates the parameters are passed in the form of dict
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        transformed_input_test_feature = preprocessor_object.fit_transform(input_feature_test_df)
